...
const BrandLogo = () => (
  ...
  >
    ...
    <div className="relative flex h-14 w-14 items-center justify-center rounded-xl bg-background">
      <motion.span
        className="bg-gradient-to-r from-primary to-secondary bg-clip-text font-orbitron text-xl font-black tracking-widest text-transparent"
        animate={{
          scale: [1, 1.05, 1],
        }}
        transition={{
            ...
            <div className="text-center lg:text-left">
              ...
              >
                <h1 className="text-3xl font-bold text-foreground sm:text-4xl lg:text-5xl">
                  Welcome to{" "}
                  <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text font-orbitron font-black tracking-widest text-transparent">
                    SOURCE0
                  </span>
                </h1>
                <motion.div
