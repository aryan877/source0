...
export const SamplePrompts = memo(
  ({ onPromptSelect, className = "", userName }: SamplePromptsProps) => {
    ...
    return (
      <div className={`mx-auto w-full max-w-3xl ${className}`}>
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-lg text-default-500">Choose a prompt below or type your own message</p>
        </div>
