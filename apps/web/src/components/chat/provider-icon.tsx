...
const ProviderIcon = React.memo(
  ({
    ...
    if (!icon) {
      // Fallback to text for providers without icons
      return (
        <div
          className={`${className} flex items-center justify-center rounded bg-default-200 text-xs font-bold text-default-600`}
        >
          {provider.charAt(0)}
        </div>
      );
